...
const excelFilename = "./db/excel/sqlite-inovation-manager-ver-4.0.xlsx"; //ten file excel cau hinh
const dbFilename = "./db/database/inovation-manager.v4.db";     //ten database muon tao
