...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main-entry-login-login-module"], {
  ...
  function srcAppMainEntryLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function LoginPage(apiCommons, apiAuth, mainService, apiImage) {
      ...
      _createClass(LoginPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.mainService.getTokenInfo().then(function (userInfo) {
            ...
            _this2.showUserInfo(); // chưa login thì yêu cầu login thôi
        ...
        key: "imageUploadEvent",
        value: function imageUploadEvent(evt, item) {
          if (!evt.target) {
            return;
          }
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return this.apiImage.createBase64Image(item.value, 600);
        ...
        value: function login() {
          var form = {
            ...
            }, // form login gồm nhập số điện thoại username và pass
            {
              ...
              key: "password",
              name: "password",
              hint: "Mật khẩu phải có chữ hoa, chữ thường, ký tự đặc biệt, số",
              input_type: "password",
              icon: "md-key",
              validators: [{
                required: true,
        ...
        value: function createNewUser(username, token) {
          var form = {
            title: "TẠO THÔNG TIN CÁ NHÂN" //khong cho nut hom
            ,
            items: [{
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_2__["CommonsService"], ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _services_main_service__WEBPACK_IMPORTED_MODULE_3__["MainService"], ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_2__["ImageService"]])], LoginPage);
    /***/
  }
}]);
