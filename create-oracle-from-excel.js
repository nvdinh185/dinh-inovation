...
const excelFilename = `./db/excel/oracle-inovation-manager-ver-1.0.xlsx`;    // ten file excel cau hinh thiết kế csdl
const dbOracle = require(`./db/oracle/db-pool`)                              // Kết nối csdl oracle
