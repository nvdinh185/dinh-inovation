...
const excelFilename = "./db/excel/fasttext-chat-bot-sample-ver1.0.xlsx";       //ten file excel cau hinh
const dbFilename = "./db/database/chatbot-fasttext-ver1.0.db";                 //ten database muon tao
