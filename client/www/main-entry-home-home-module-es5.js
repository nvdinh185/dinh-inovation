...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main-entry-home-home-module"], {
  ...
  function srcAppMainEntryHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function HomePage(apiAuth, router, mainService) {
      ...
      _createClass(HomePage, [{
        ...
        value: function init() {
          ...
          this.apiAuth.getDynamicUrl(this.apiAuth.serviceUrls.RESOURCE_SERVER + "/get-top-actions").then(function (data) {
            ...
            _this.topUsersActions = data; // console.log(this.topUsersActions);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], src_app_services_main_service__WEBPACK_IMPORTED_MODULE_4__["MainService"]])], HomePage);
    /***/
  }
}]);
