...
let AppComponent = class AppComponent {
    ...
    init() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.apiAuth.serviceUrls.RESOURCE_SERVER = _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].RESOURCE_SERVER;
            ...
            this.userInfo = yield this.mainService.getTokenInfo();
    ...
    getTokenInfo() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.token && this.userInfo) {
                ...
                if (token) {
                    try {
                        let result = yield this.apiAuth.getDynamicUrl(this.apiAuth.serviceUrls.AUTH_SERVER + '/get-user-info', token);
                        // console.log(result);
...
module.exports = __webpack_require__(/*! E:\MYDATA\LAPTRINH\NODE4\dinh-inovation\client\src\main.ts */"./src/main.ts");
