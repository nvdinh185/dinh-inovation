...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chatbot-chat-bot-chat-bot-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppChatbotChatBotChatBotPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppChatbotChatBotChatBotRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _chat_bot_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./chat-bot.page */
  ...
  /***/
  function srcAppChatbotChatBotChatBotModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _chat_bot_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./chat-bot-routing.module */
    "./src/app/chatbot/chat-bot/chat-bot-routing.module.ts");
    /* harmony import */


    var _chat_bot_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./chat-bot.page */
    "./src/app/chatbot/chat-bot/chat-bot.page.ts");
    /* harmony import */
    ...
    ChatBotPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], src_app_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_8__["Ngxi4DynamicServiceModule"], _chat_bot_routing_module__WEBPACK_IMPORTED_MODULE_5__["ChatBotPageRoutingModule"]],
  ...
  /***/
  function srcAppChatbotChatBotChatBotPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppChatbotChatBotChatBotPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ChatBotPage(route, apiCommons, apiAuth, mainService) {
      ...
      _createClass(ChatBotPage, [{
            ...
            if (this.message.length > 0) {
              ...
              this.apiAuth.postDynamicJson(this.apiAuth.serviceUrls.SOCKET_SERVER + '/request-answer', {
                ...
                if (answer && answer.status === "OK") {
                  ...
                  _this4.conversations.unshift({
                    request: _this4.conversion.request,
                    response: answer.message,
                    created_time: _this4.conversion.created_time
                  }); // muốn sửa câu trả lời thì sửa ngay cái đối tượng này
                  // thì gán đối tượng đàm thoại bằng bảng ghi cuối cùng để sửa


                  _this4.conversion = _this4.conversations[0];
                }
        ...
        key: "keyInput",
        value: function keyInput() {
          this.onClickSend();
        } // bấm vào menu

      }, {
        key: "onClickMore",
        value: function onClickMore(evt) {
          var _this5 = this;
        ...
        value: function processDetails(itemOrItems) {
          ...
          var cmd = itemOrItems.value; // thực hiện gọi hàm huấn luyện
          ...
          if (cmd === 'TRAIN') {
            ...
            this.apiAuth.postDynamicJson(this.apiAuth.serviceUrls.SOCKET_SERVER + "/run-train", {
              ...
              _this6.apiCommons.hideLoader();

              _this6.apiCommons.showToast(result && result.message ? result.message : 'Đã huấn luyện thành công, bạn có thể test thử nhé', 2000, 'success');
            }).catch(function (err) {
              // console.log('err', err);
              _this6.apiCommons.hideLoader();

              _this6.apiCommons.showToast(err && err.message ? err.message : 'Lỗi huấn luyện cho máy', 3000, 'danger');
            });
        ...
        value: function onClickRepair() {
          ...
          if (this.isRepairing && this.conversion.request && this.conversion.response && this.conversion.intent_name) {
            ...
            this.apiAuth.postDynamicJson(this.apiAuth.serviceUrls.SOCKET_SERVER + "/train-answer", {
              ...
              _this7.apiCommons.showToast(result && result.message ? result.message : 'Soạn bài giảng cho máy thành công', 2000, 'success');
            }).catch(function (err) {
              // console.log('err', err);
              _this7.apiCommons.showToast(err && err.message ? err.message : 'Lỗi soạn bài giảng cho máy', 3000, 'danger');
            });
          }
        ...
        key: "checkProbRequest",
        value: function checkProbRequest() {
          var _this8 = this;

          this.apiAuth.getDynamicUrl(this.apiAuth.serviceUrls.SOCKET_SERVER + "/get-predict?message=" + this.conversion.request, true).then(function (results) {
            _this8.showResultCheck(results);
          }).catch(function (err) {
            _this8.apiCommons.showToast(err && err.message ? err.message : 'Lỗi kiểm tra xác suất', 3000, 'danger');
          });
        }
      }, {
        key: "showResultCheck",
        value: function showResultCheck(results) {
          var details = {
            type: "details",
            details: []
          };
    ...
    ChatBotPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! raw-loader!./chat-bot.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/chatbot/chat-bot/chat-bot.page.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./chat-bot.page.scss */
      "./src/app/chatbot/chat-bot/chat-bot.page.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_3__["CommonsService"], ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], src_app_services_main_service__WEBPACK_IMPORTED_MODULE_4__["MainService"]])], ChatBotPage);
    /***/
  }
}]);
//# sourceMappingURL=chatbot-chat-bot-chat-bot-module-es5.js.map