...
const excelFilename = "./db/excel/sqlite-inovation-manager-ver-5.2.xlsx";   //ten file excel cau hinh
const dbFilename = "./db/database/inovation-manager.v6.db";                 //ten database muon tao
