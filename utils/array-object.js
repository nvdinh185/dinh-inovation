...
const deleteObjectKey = (obj, key) => {
    ...
    // obj.length = Object.keys(obj).length ? Object.keys(obj).length : undefined;
...
module.exports = {
    ...
    getJsonStringify: getJsonStringify, // Định dạng chuỗi của json để truyền đi

    orderArrayObjects: orderArrayObjects, // Sắp xếp thứ tự theo một trường

    getMaxValue: getMaxValue, // Lấy giá trị cực đại
    getTimestamp: getTimestamp, // lấy thời gian hiện tại yyyy-mm-dđ hh24:mi:ss
    multiThreadRuning: multiThreadRuning, // chạy đa luồng
    ...
    createTreeWeight: createTreeWeight,  //Tính toán trọng số và sắp xếp trật tự theo cây
    ...
    getPhoneFromText: getPhoneFromText,
    getEmailFromText: getEmailFromText,
    getLinkFromText: getLinkFromText,
