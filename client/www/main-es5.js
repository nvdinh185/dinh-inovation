...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        "idea-entry-idea-idea-module").then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        ...
        "idea-entry-idea-detail-idea-detail-module").then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | admin-entry-upgrade-upgrade-module */
        "admin-entry-upgrade-upgrade-module").then(__webpack_require__.bind(null,
        /*! ./admin-entry/upgrade/upgrade.module */
        "./src/app/admin-entry/upgrade/upgrade.module.ts")).then(function (m) {
          return m.UpgradePageModule;
        });
      }
    }, {
      path: 'user-activity',
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | main-entry-home-user-activity-user-activity-module */
        "main-entry-home-user-activity-user-activity-module").then(__webpack_require__.bind(null,
        /*! ./main-entry/home/user-activity/user-activity.module */
        "./src/app/main-entry/home/user-activity/user-activity.module.ts")).then(function (m) {
          return m.UserActivityPageModule;
        });
      }
    }, {
      path: 'chat-bot',
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | chatbot-chat-bot-chat-bot-module */
        "chatbot-chat-bot-chat-bot-module").then(__webpack_require__.bind(null,
        /*! ./chatbot/chat-bot/chat-bot.module */
        "./src/app/chatbot/chat-bot/chat-bot.module.ts")).then(function (m) {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_main_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(platform, splashScreen, statusBar, menuCtrl, router, apiAuth, apiCommons, mainService) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function onResize(event) {
          var win = !!event ? event.target : window;
        ...
        value: function initializeApp() {
          ...
          this.platform.ready().then(function () {
            _this.onResize(); // lấy kích thước màn hình để xem
        ...
        value: function init() {
          ...
          this.apiCommons.subscribe('event-login-ok', function (userInfo) {
            _this2.userInfo = userInfo; // gọi tổ chức menu tùy vào login hay chưa

            _this2.refresh();
          });
          this.apiCommons.subscribe('event-logout-ok', function () {
            _this2.userInfo = null; // gọi tổ chức menu tùy vào login hay chưa
        ...
        value: function refresh() {
          ...
          var menuAll = JSON.parse(this.defaultMenu);
          menuAfterlogin.forEach(function (el) {
            if (!menuAll.find(function (x) {
              return x.id === el.id;
            })) menuAll.splice(1, 0, el);
          });
          menuDeveloper.forEach(function (el) {
            if (!menuAll.find(function (x) {
              return x.id === el.id;
          ...
          if (event && event.item && event.item.url) {
            if (event.item.options) {
              ...
              this.router.navigate([event.item.url], {
                queryParams: event.item.options
              });
            } else {
              this.router.navigate([event.item.url]);
            }
        ...
        key: "onClickUserImage",
        value: function onClickUserImage(type) {
          this.router.navigate(['/login']);
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('window:resize', ['$event']), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [Event]), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:returntype", void 0)], AppComponent.prototype, "onResize", null);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["MenuController"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"], ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_6__["CommonsService"], _services_main_service__WEBPACK_IMPORTED_MODULE_7__["MainService"]])], AppComponent);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_tree_menu_tree_menu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./components/tree-menu/tree-menu */
    "./src/app/components/tree-menu/tree-menu.ts");
    /* harmony import */


    var ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ngxi4-dynamic-service */
    "./node_modules/ngxi4-dynamic-service/fesm2015/ngxi4-dynamic-service.js");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _components_tree_menu_tree_menu__WEBPACK_IMPORTED_MODULE_9__["TreeMenu"]],
      entryComponents: [_components_tree_menu_tree_menu__WEBPACK_IMPORTED_MODULE_9__["TreeMenu"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), ngxi4_dynamic_service__WEBPACK_IMPORTED_MODULE_10__["Ngxi4DynamicServiceModule"].forRoot(), _shared_module__WEBPACK_IMPORTED_MODULE_11__["SharedModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"]],
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_12__["InAppBrowser"], {
  ...
  function srcAppComponentsIdeaCardIdeaCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(IdeaCardComponent, [{
        ...
        key: "onClickCommand",
        value: function onClickCommand(item) {
    ...
    function () {
      ...
      _createClass(MainService, [{
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 4:
                      token = this.apiStorage.read("TOKEN");
        ...
        value: function saveToken(token, userInfo) {
          ...
          this.userInfo = userInfo; // Lưu token trong interceptor để sử dụng post, request tự động chèn token 
  ...
  function srcAppSharedModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var time_ago_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! time-ago-pipe */
    "./node_modules/time-ago-pipe/esm2015/time-ago-pipe.js");
    /* harmony import */


    var _components_idea_card_idea_card_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./components/idea-card/idea-card.component */
    "./src/app/components/idea-card/idea-card.component.ts");
    /* harmony import */
    ...
    SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], ngx_autosize__WEBPACK_IMPORTED_MODULE_7__["AutosizeModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"]],
      declarations: [// Các pipe dữ liệu không chèn ở entry
      _components_idea_card_idea_card_component__WEBPACK_IMPORTED_MODULE_6__["IdeaCardComponent"], time_ago_pipe__WEBPACK_IMPORTED_MODULE_5__["TimeAgoPipe"]],
      exports: [// Phải khai báo xuất bản ra mới sử dụng được nhé
      _components_idea_card_idea_card_component__WEBPACK_IMPORTED_MODULE_6__["IdeaCardComponent"], ngx_autosize__WEBPACK_IMPORTED_MODULE_7__["AutosizeModule"], time_ago_pipe__WEBPACK_IMPORTED_MODULE_5__["TimeAgoPipe"]]
    })], SharedModule);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/cuongdq/IONIC/m-inovation/client/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
